        ...
        <div className='flex flex-col xl:flex-row xl:gap-[50px]'>
          <div className='w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none'>
            <div className='flex gap-[30px] flex-col h-[50%]'>
              ...
              {/* project-category */}
              <h2 className='text-[42px] group-hover:text-accent font-bold leading-none text-white transition-all duration-500 capitalize'>
              ...
              <ul className='flex gap-4'>
                {project.stack.map(({ name }, index) => {
                  return (
                    <li
                      key={index}
                      className='text-xl text-accent capitalize'
                    >
                      {name}
              ...
              {projects.map((project, index) => {
                return (
                  <SwiperSlide
                    ...
                    className='w-full'
                  >
                    <div className='h-[460px] relative group flex justify-between items-center bg-pink-50/20'>
                      {/* overlay */}
